...
module.exports = function servePublicFiles() {
  ...
  function verify(
    ...
    if (
      ...
      utils.solveIf(challenges.directoryListingChallenge, () => {
  ...
  function verifySuccessfulPoisonNullByteExploit(file: string) {
    utils.solveIf(challenges.easterEggLevelOneChallenge, () => {
      return file.toLowerCase() === "eastere.gg";
    });
    utils.solveIf(challenges.forgottenDevBackupChallenge, () => {
      return file.toLowerCase() === "package.json.bak";
    });
    utils.solveIf(challenges.forgottenBackupChallenge, () => {
      return file.toLowerCase() === "coupons_2013.md.bak";
    });
    utils.solveIf(challenges.misplacedSignatureFileChallenge, () => {
